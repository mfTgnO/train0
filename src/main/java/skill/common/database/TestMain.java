...
//    static String jdbcUrl = "jdbc:mysql://192.168.0.1:3306/test";
    static String jdbcUrl = "jdbc:mysql://PC-20180118KOQJ:3306/xjerp?useUnicode=true&characterEncoding=UTF-8";
...
//    static String passwd = "123456";
    static String passwd = "admin123456";
//    static String passwd = "root";

    // 连接池初始化大小
//    static int initialSize = 15;
